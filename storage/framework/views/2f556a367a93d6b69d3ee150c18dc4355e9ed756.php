              ...
              <div class="row">
               <center>
				...
				<?php endif; ?>
                 ...
                 <form class="form-horizontal" method="post"  action="<?php echo e(url('/admin/add_Sermon')); ?>" enctype="multipart/form-data">
                    
                <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Sermon Title</label>

                        <div class="col-lg-8">
                            <input type="text" id="text1" name="title" value="" placeholder="e.g The Jesus in Me" class="form-control" />
                        </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="text1" name="books" value="" placeholder="e.g Ephesians 12" class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <br><br>
                    <div class="col-lg-12 text-center">
                      <button type="submit" class="btn btn-success"><i class="icon-plus icon-white"></i> Publish Sermon</button>
                    </div>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megapipe/gracecommunitybiblechurch.org/resources/views/admin/addSermon.blade.php ENDPATH**/ ?>