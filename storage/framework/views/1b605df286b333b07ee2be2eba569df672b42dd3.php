<div id="right">
            ...
            <div class="well well-small">
                ...
                <button type="button" onclick="window.open('<?php echo e(url('/admin/events')); ?>','_self')" class="btn btn-info btn-block"> Calendar </button>
...
<?php /**PATH /home/designekta/gcbc/resources/views/admin/right.blade.php ENDPATH**/ ?>