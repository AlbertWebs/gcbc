              ...
              <div class="row">
               <center>
				...
				<?php endif; ?>
                 ...
                 <form class="form-horizontal" method="post"  action="<?php echo e(url('/admin/edit_Blog')); ?>/<?php echo e($Blog->id); ?>" enctype="multipart/form-data">
                    
                <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Property Title</label>

                        <div class="col-lg-8">
                            <input type="text" id="text1" name="title" value="<?php echo e($Blog->title); ?>" placeholder="e.g 2 Bedroom Houses Master Ensuite" class="form-control" />
                        </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="date" id="text1" name="date" value="<?php echo e($Blog->date); ?>" class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="text1" name="video" value="<?php echo e($Blog->video); ?>" placeholder="e.g FUR2SWJDlyE" class="form-control" />
                    </div>
                </div>
                ...
                src="https://www.youtube.com/embed/<?php echo e($Blog->video); ?>">
                </iframe>
                <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select name="category" data-placeholder="Choose Category" class="form-control chzn-select" tabindex="2">
                            ...
                            <?php $__currentLoopData = $Feetch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option selected value="<?php echo e($item->id); ?>"><?php echo e($item->cat); ?></option>
                    ...
                    <center>
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <div class="">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/blogs/<?php echo e($Blog->image_one); ?>" alt="" /></div>
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <div class="">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/blogs/<?php echo e($Blog->image_two); ?>" alt="" /></div>
                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                    <div>
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <div class="">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/blogs/<?php echo e($Blog->image_three); ?>" alt="" /></div>
                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                    <div>
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <div class="">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/blogs/<?php echo e($Blog->image_four); ?>" alt="" /></div>
                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                    <div>
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <div class="">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/blogs/<?php echo e($Blog->image_five); ?>" alt="" /></div>
                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                    <div>
                    ...
                    <input type="hidden" name="image_five_cheat" value="<?php echo e($Blog->image_five); ?>">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megapipe/gracecommunitybiblechurch.org/resources/views/admin/editBlog.blade.php ENDPATH**/ ?>