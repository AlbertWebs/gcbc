				...
				<?php endif; ?>
                 ...
                 <form class="form-horizontal" method="post"  action="<?php echo e(url('/admin/savesitesettings')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" value="<?php echo e($value->mpesa); ?>" name="mpesa" type="text" placeholder="e.g +254723014032" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" value="<?php echo e($value->paypal); ?>" name="paypal" type="text" placeholder="e.g email@domain.com" >
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="div-1" class="body collapse in">
                                        ...
                                        <textarea name="welcome" id="wysihtml55" class="form-control" rows="10"><?php echo e($value->welcome); ?></textarea>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/logo/<?php echo e($value->logoo); ?>" alt="" /></div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                <div>
                    ...
                    <input type="hidden" name="logoo_cheat" value="<?php echo e($value->logoo); ?>">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megapipe/gracecommunitybiblechurch.org/resources/views/admin/sitesettings.blade.php ENDPATH**/ ?>