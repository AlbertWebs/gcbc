            ...
            <div class="church_navigation pull-right">
                ...
                <nav class="navigation">                                                          
                    <ul>
                        ...
                        <li><a  href="#">Give</a>
                            <ul class="children submenu">
                                <li><a style="color:#ffffff !important" href="<?php echo e(url('/')); ?>/give-paybill">PayBill Number</a></li>
                                <li><a style="color:#ffffff !important" href="<?php echo e(url('/')); ?>#">Online Giving</a></li>
                            </ul>
                        </li>
                        <li><a href="<?php echo e(url('/')); ?>/contact-us">contact us</a></li>
                    </ul>
...
<!--church header ends-->
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/megapipe/gracecommunitybiblechurch.org/resources/views/front/menu-pages.blade.php ENDPATH**/ ?>