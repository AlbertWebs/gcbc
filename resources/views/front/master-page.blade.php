...
<head>
    ...
    <title>{{$title}}</title>
        {{--  --}}
        <meta name="description" content="Grace Community Bible Church - {{$titles}}" />
        <meta name="keywords" content="Grace Community Bible Church" />
        <meta name="author" content="Designekta Studio" />
        <link rel="canonical" href="https://gracecommunitybiblechurch.org/news-and-events/{{$slung}}"/>
        
     
        <meta property="og:description" content="Grace Community Bible Church - {{$titles}}">
        <meta property="og:image" content="https://gracecommunitybiblechurch.org/uploads/blogs/{{$image}}" />
        <meta property="og:image:secure_url" content="https://gracecommunitybiblechurch.org/uploads/blogs/{{$image}}">
        <meta property="og:title" content="{{$titles}} | Grace Community Bible Church" />
        <meta property="og:url" content="https://gracecommunitybiblechurch.org/news-and-events/{{$slung}}" />
